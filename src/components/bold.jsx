    ...
    <div className='flex flex-col w-70 font-retro'>
      ...
      <div className='bg-amber-50/60 p-3 rounded-lg border-2 border-zinc-900 shadow-[3px_3px_0px_#18181b] flex items-center justify-between gap-2'>
        <button 
          type="button"
          onClick={toggleBold} 
          className={`size-10 rounded-md border-2 border-zinc-900 text-lg font-bold cursor-pointer flex justify-center items-center transition-all ${
            bold 
        ...
        <button 
          ...
          className={`size-10 rounded-md border-2 border-zinc-900 text-lg font-serif italic cursor-pointer flex justify-center items-center transition-all ${
            italic 
              ? "bg-zinc-900 text-amber-100 shadow-none translate-x-0.5 translate-y-0.5" 
              : "bg-white text-zinc-900 shadow-[2px_2px_0px_#18181b] hover:bg-amber-100"
          }`}
        ...
        <button 
          ...
          className={`size-10 rounded-md border-2 border-zinc-900 text-lg font-semibold underline cursor-pointer flex justify-center items-center transition-all ${
            underline 
              ? "bg-zinc-900 text-amber-100 shadow-none translate-x-0.5 translate-y-0.5" 
              : "bg-white text-zinc-900 shadow-[2px_2px_0px_#18181b] hover:bg-amber-100"
          }`}
        ...
        <button 
          ...
          className={`size-10 rounded-md border-2 border-zinc-900 text-lg line-through cursor-pointer flex justify-center items-center transition-all ${
            strike 
              ? "bg-zinc-900 text-amber-100 shadow-none translate-x-0.5 translate-y-0.5" 
              : "bg-white text-zinc-900 shadow-[2px_2px_0px_#18181b] hover:bg-amber-100"
          }`}
